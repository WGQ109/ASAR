...
def gendata(data_path,
            ...
            benchmark='xview',
            part='eval'):
    training_split_file_folder = '/datasets/original_data/pkummd/v1/'
    if benchmark=='xview':
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--data_path', default='/datasets/original_data/pkummd/skeleton_pku_v1')
    parser.add_argument('--out_folder', default='/datasets/crossclr_pkummd/pku_part1')

    parser.add_argument('--ignored_sample_path',
                        default='/datasets/original_data/pkummd/v1/samples_with_missing_skeletons.txt')
