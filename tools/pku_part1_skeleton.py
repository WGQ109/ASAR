...
skeleton_folder = '/datasets/original_data/pkummd/v1/PKU_Skeleton_Renew/'
label_folder = '/datasets/original_data/pkummd/v1/Train_Label_PKU_final/'
save_path = '/datasets/original_data/pkummd/skeleton_pku_v1/'
