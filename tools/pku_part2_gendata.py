...
def gendata(data_path,
            ...
            benchmark='xview',
            part='eval'):
    training_split_file_folder = '/datasets/original_data/pkummd/v2/'
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--data_path', default='/datasets/original_data/pkummd/skeleton_pku_v2')
    parser.add_argument('--out_folder', default='/datasets/crossclr_pkummd/pku_part2')

    parser.add_argument('--ignored_sample_path',
                        default='/datasets/original_data/pkummd/v2/samples_with_missing_skeletons_v2.txt')
