...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--data_path', default='/data/wgq/action_dataset/original/nturgb+d_skeletons/')
    parser.add_argument(
        '--ignored_sample_path',
        default='/data/wgq/action_dataset/original/NTU_RGBD_samples_with_missing_skeletons.txt')
    parser.add_argument('--out_folder', default='/data/wgq/action_dataset/ntu60')
