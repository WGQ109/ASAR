...
skeleton_folder = '/datasets/original_data/pkummd/v2/skeleton/'
label_folder = '/datasets/original_data/pkummd/v2/label/'
save_path = '/datasets/original_data/pkummd/skeleton_pku_v2/'
